...
setwd("/Users/kayla/Documents/thesis_data/us/")
...
isBecomes
r2002 <- reclassify(rnet, rcl=isBecomes,filename="us_loss_2002.tif")

# Repeat for 2003
isBecomes <- cbind(c(0:18), c(rep(0,3),100,rep(0,15)))
isBecomes
r2003 <- reclassify(rnet, rcl=isBecomes,filename="us_loss_2003.tif")

# Repeat for 2004
isBecomes <- cbind(c(0:18), c(rep(0,4),100,rep(0,14)))
isBecomes
r2004 <- reclassify(rnet, rcl=isBecomes,filename="us_loss_2004.tif")

# Repeat for 2005
isBecomes <- cbind(c(0:18), c(rep(0,5),100,rep(0,13)))
isBecomes
r2005 <- reclassify(rnet, rcl=isBecomes,filename="us_loss_2005.tif")

# Repeat for 2006
isBecomes <- cbind(c(0:18), c(rep(0,6),100,rep(0,12)))
isBecomes
r2006 <- reclassify(rnet, rcl=isBecomes,filename="us_loss_2006.tif")

# Repeat for 2007
isBecomes <- cbind(c(0:18), c(rep(0,7),100,rep(0,11)))
isBecomes
r2007 <- reclassify(rnet, rcl=isBecomes,filename="us_loss_2007.tif")

# Repeat for 2008
isBecomes <- cbind(c(0:18), c(rep(0,8),100,rep(0,10)))
isBecomes
r2008 <- reclassify(rnet, rcl=isBecomes,filename="us_loss_2008.tif")

# Repeat for 2009
isBecomes <- cbind(c(0:18), c(rep(0,9),100,rep(0,9)))
isBecomes
r2009 <- reclassify(rnet, rcl=isBecomes,filename="us_loss_2009.tif")

# Repeat for 2010
isBecomes <- cbind(c(0:18), c(rep(0,10),100,rep(0,8)))
isBecomes
r2010 <- reclassify(rnet, rcl=isBecomes,filename="us_loss_2010.tif")

# Repeat for 2011
isBecomes <- cbind(c(0:18), c(rep(0,11),100,rep(0,7)))
isBecomes
r2011 <- reclassify(rnet, rcl=isBecomes,filename="us_loss_2011.tif")

# Repeat for 2012
isBecomes <- cbind(c(0:18), c(rep(0,12),100,rep(0,6)))
isBecomes
r2012 <- reclassify(rnet, rcl=isBecomes,filename="us_loss_2012.tif")

# Repeat for 2013
isBecomes <- cbind(c(0:18), c(rep(0,13),100,rep(0,5)))
isBecomes
r2013 <- reclassify(rnet, rcl=isBecomes,filename="us_loss_2013.tif")

# Repeat for 2014
isBecomes <- cbind(c(0:18), c(rep(0,14),100,rep(0,4)))
isBecomes
r2014 <- reclassify(rnet, rcl=isBecomes,filename="us_loss_2014.tif")

# Repeat for 2015
isBecomes <- cbind(c(0:18), c(rep(0,15),100,rep(0,3)))
isBecomes
r2015 <- reclassify(rnet, rcl=isBecomes,filename="us_loss_2015.tif")

# Repeat for 2016
isBecomes <- cbind(c(0:18), c(rep(0,16),100,rep(0,2)))
isBecomes
r2016 <- reclassify(rnet, rcl=isBecomes,filename="us_loss_2016.tif")

# Repeat for 2017
isBecomes <- cbind(c(0:18), c(rep(0,17),100,rep(0,1)))
isBecomes
r2017 <- reclassify(rnet, rcl=isBecomes,filename="us_loss_2017.tif")

# Repeat for 2018
isBecomes <- cbind(c(0:18), c(rep(0,18),100))
isBecomes
r2018 <- reclassify(rnet, rcl=isBecomes,filename="us_loss_2018.tif")