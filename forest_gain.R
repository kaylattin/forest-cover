...
gainresults <- extract(gain, buffer, fun=mean, df=TRUE, sp=TRUE, normalizeWeights=TRUE)
writeOGR(gainresults, dsn="/Users/kayla/Docauments/BBS data", layer="forestgain2012", driver="ESRI Shapefile")
